...
public class CreateUserConfirmAction extends ActionSupport implements SessionAware {
	...
	private List<String> isExistUserIdErrorMessageList = new ArrayList<String>();
	...
	public String execute() {
		...
		if(familyNameErrorMessageList.size()==0
				...
				&& isExistUserIdErrorMessageList.size()==0
				&& passwordErrorMessageList.size()==0){
			if(!StringUtils.isEmpty(userInfoDTO.getUserId())){
				isExistUserIdErrorMessageList.add("使用できないユーザーIDです。");
				result = ERROR;
			}else{
				result = SUCCESS;
			}
	...
	public List<String> getIsExistUserIdErrorMessageList() {
		return isExistUserIdErrorMessageList;
	}

	public void setIsExistUserIdErrorMessageList(List<String> isExistUserIdErrorMessageList) {
		this.isExistUserIdErrorMessageList = isExistUserIdErrorMessageList;
	}
	...
	public List<String> getIsExistUserIdErrorMessage() {
		return isExistUserIdErrorMessageList;
	}

	public void setIsExistUserIdErrorMessage(List<String> isExistUserIdErrorMessage) {
		this.isExistUserIdErrorMessageList = isExistUserIdErrorMessage;
	}
